...
export async function calculateConfiguredAssessmentsForSession(sessionId:string){return Promise.all([calculateSspm2011ForSession(sessionId),calculateSccsForSession(sessionId)])}
